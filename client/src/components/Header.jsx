...
const Header = ({ titleButton, signIn = true, titleLink }) => {
  return (
<<<<<<< HEAD
    <header className="flex flex-col items-center justify-evenly pt-2 md:flex-row lg:flex-row lg:items-center lg:pt-0 ">
...
>>>>>>> d0d95fc (Add layout and page components)
        <Link
          href="#"
...
<<<<<<< HEAD
      <div className="order-2 flex flex-row items-center justify-between md:order-3 lg:order-3">
        ...
        <button className="h-10 w-40 rounded-lg border-none bg-[#07C051] px-4 py-2 text-lg font-bold text-white hover:cursor-pointer active:bg-[#33ad64]">
=======
